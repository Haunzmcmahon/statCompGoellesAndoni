...
### Why we have to remove the values where old_age_benfits are 0€
...
The distribution of old_age_benefits is heavily right-skewed, with a large concentration of values at €0 (zero-inflated). This indicates that most individuals do not receive old-age benefits. The histogram also shows a unimodal distribution, where the majority of non-zero values are clustered at lower benefit amounts, with a few outliers receiving significantly higher benefits. This could be because generally individuals in Austria start to receive old age benefits after already working a substantial number of years or reaching certain age threshholds.
...
The distribution of old_age_benefits is heavily right-skewed, with a large concentration of values at €0 (zero-inflated). This indicates that most individuals do not receive old-age benefits. The histogram also shows a unimodal distribution, where the majority of non-zero values are clustered at lower benefit amounts, with a few outliers receiving significantly higher benefits.
