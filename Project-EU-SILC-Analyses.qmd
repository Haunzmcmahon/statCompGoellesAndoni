...
lm_age_econ_region <- lm(old_age_benefits ~ age_years + economic_status + household_size, data = cleaned_data)

# Summarize the model
summary(lm_age_econ_region)


lm_region_only <- lm(old_age_benefits ~ cleaned_data$main_income_earner
                     , data = cleaned_data)
summary(lm_region_only)
